...
halloween.night <- function(){
  ...
  tot.candy # R automatically gives specific return statement.
}
Nsim <- 10000
...
set.seed(0)
results <- sapply(1:10000, function(x) num6s(4))
...
mean(sapply(1:10000, function(x) sum(roll.dice(3)) == 7)) # 6.94%
